...
namespace NBrowse.Selection
{
	public static class Attribute
	{
		...
		public static bool IsGenerated(this Method method) => method.HasAttribute<CompilerGeneratedAttribute>();

		public static bool IsGenerated(this Type type) => type.HasAttribute<CompilerGeneratedAttribute>();
	}
}