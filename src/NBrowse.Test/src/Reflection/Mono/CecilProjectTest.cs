...
namespace NBrowse.Test.Reflection.Mono
{
    public class CecilProjectTest
    {
        ...
        public void Assemblies()
        {
            ...
            Assert.That(project.Assemblies, Has.Some.Matches<NBrowse.Reflection.Assembly>(a => a.Name == AssemblyName));
        }
        ...
        public void FilterAssembly_Include()
        {
            ...
            Assert.That(project.FilterAssemblies(new[] { "Missing1", AssemblyName, "Missing2" }),
                Has.Some.Matches<NBrowse.Reflection.Assembly>(a => a.Name == AssemblyName));
        }
